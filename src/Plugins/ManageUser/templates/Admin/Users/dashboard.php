...
<head>
    ...
    <!-- Pignose Calender -->
    <link href="/webroot/plugins/pg-calendar/css/pignose.calendar.min.css" rel="stylesheet">
    <!-- Chartist -->
    <link rel="stylesheet" href="/webroot/plugins/chartist/css/chartist.min.css">
    <link rel="stylesheet" href="/webroot/plugins/chartist-plugin-tooltips/css/chartist-plugin-tooltip.css">
    <!-- Custom Stylesheet -->
                                ...
                                <ul>
                                    <li class="notification-unread">
                                        <a href="javascript:void()">
                                            <img class="float-left mr-3 avatar-img" src="/webroot/images/avatar/1.jpg" alt="">
...
<!--                    </li>-->
                    <li class="icons dropdown">
                        <div class="user-img c-pointer position-relative"   data-toggle="dropdown">
                            ...
                            <img src="/webroot/images/user/1.png" height="40" width="40" alt="">
                        </div>
...
<!--            </div>-->
    ...
    ***********************************-->
    <div class="footer">
        <div class="copyright">
            <p>Copyright &copy; Designed & Developed by <a href="">Mahfuz Alam</a></p>
        </div>
    </div>
    <!--**********************************
        Footer end
