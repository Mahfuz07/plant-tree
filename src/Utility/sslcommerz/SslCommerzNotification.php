...
//                dd($requested_url);
                ...
                curl_setopt($handle, CURLOPT_RETURNTRANSFER, true);
                 ...
                 if (Configure::read('LOCAL_HOST') == "LOCAL") {
...
//                                dd("hello");
    ...
    {
        $this->successUrl = Router::fullBaseUrl() . '/' . $this->config['success_url'];
    }
    ...
    {
        $this->failedUrl = Router::fullBaseUrl() . '/' . $this->config['failed_url'];
    }
    ...
    {
        $this->cancelUrl = Router::fullBaseUrl() . '/' . $this->config['cancel_url'];
    }
