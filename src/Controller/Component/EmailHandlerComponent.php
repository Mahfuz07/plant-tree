...
class EmailHandlerComponent extends BaseComponent
{
    ...
    function OrderCreateEmail($order, $name = ''): bool
    {
        $mail = new PHPMailer(true);
        ...
        try {
            ...
            $mail->isHTML(true);                                  //Set email format to HTML
            $mail->Subject = 'Your Order Successfully Created';
            $mail->Body    = "Hello " . $order['customer_name'] .", <br>Your Order " .$order['order_id']. " Successfully Created!";
            $mail->AltBody = 'This is the body in plain text for non-HTML mail clients';
